...
class Meteor:
    ...
    def __init__(self, type, vel, xsize):
    ...
    def UpdatePos(self):
        self.hitbox = (self.pos[0]-self.size[0]/2, self.pos[1]-self.size[1]/2  ,self.mSize-10, self.mSize-10) 
    ...
    def Draw(self,win, hitbox = False):
        ...
        if hitbox:
            p.draw.rect(win,(255,0,0), (self.pos[0]+self.hitbox[2]/2, self.pos[1]-self.hitbox[3]/2, 3, self.hitbox[3]))
            p.draw.rect(win,(255,255,0), (self.pos[0]-self.hitbox[2]/2, self.pos[1]-self.hitbox[3]/2, 3, self.hitbox[3]))
            p.draw.rect(win,(255,255,255), (self.pos[0]-self.hitbox[2]/2, self.pos[1]+self.hitbox[3]/2, self.hitbox[2], 3))
            p.draw.rect(win,(255,0,255), (self.pos[0]-self.hitbox[2]/2, self.pos[1]-self.hitbox[3]/2, self.hitbox[2], 3))
    @classmethod
    def getMeteors(cls):
        return cls.meteors
